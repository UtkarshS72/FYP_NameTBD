...
module conv3x3_seq_shift(
    ...
    assign pixel_raw = pixels_reg[7:0];    // this,
    assign coeff_raw = kernel_reg[7:0];    // this,
        ...
        begin
            ...
            begin
                ...
                begin
                    ...
                    pixels_reg <= pixels_reg >> 8;        // and this are the 
                    kernel_reg <= kernel_reg >> 8;        // only lines that changed from the initial version
                end
            end        
        end
    end
